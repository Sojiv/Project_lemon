...
QT_MOC_LITERAL(1, 13, 13), // "rejudgeSignal"
QT_MOC_LITERAL(2, 27, 0), // ""
QT_MOC_LITERAL(3, 28, 13) // "anchorClicked"

    },
    "DetailDialog\0rejudgeSignal\0\0anchorClicked"
};
...
void DetailDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (DetailDialog::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&DetailDialog::rejudgeSignal)) {
                *result = 0;
                return;
            }
        }
