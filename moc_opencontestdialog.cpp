...
struct qt_meta_stringdata_OpenContestDialog_t {
    QByteArrayData data[3];
    char stringdata0[36];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_OpenContestDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OpenContestDialog_t qt_meta_stringdata_OpenContestDialog = {
    {
QT_MOC_LITERAL(0, 0, 17), // "OpenContestDialog"
QT_MOC_LITERAL(1, 18, 16), // "selectionChanged"
QT_MOC_LITERAL(2, 35, 0) // ""

    },
    "OpenContestDialog\0selectionChanged\0"
};
...
QT_INIT_METAOBJECT const QMetaObject OpenContestDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_OpenContestDialog.data,
      qt_meta_data_OpenContestDialog,  qt_static_metacall, nullptr, nullptr}
};
...
void *OpenContestDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OpenContestDialog.stringdata0))
