...
QT_MOC_LITERAL(1, 5, 19), // "problemTitleChanged"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 30) // "compilerConfigurationRefreshed"

    },
    "Task\0problemTitleChanged\0\0"
    "compilerConfigurationRefreshed"
};
...
void Task::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::problemTitleChanged)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Task::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Task::compilerConfigurationRefreshed)) {
                *result = 1;
                return;
            }
        }
